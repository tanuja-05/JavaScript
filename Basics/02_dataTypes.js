//since js  has newer versions and to treat all syntaxes & code as same
// we use "use strict" to treat all js code as newer version

"use strict";

// alert("hello") => We are in node environment, js engine is in the browser so it gets executed in browser
...
//boolean => true/false
//null =>standalone value ( ex: no temperature is null, but 0 temperature is considered to be a temperature)
//undefined => declared but not initialized
//symbol => uniqueness widely used in reactjs
